    ...
    <div class="exam_item" v-for="item in examData"
      ...
      <div class="exam_desc">
        ...
        <div class="exam_num">
          ...
          <span class="highlight pull-right">{{item.ExamCredit.toFixed(1)}}学时</span>
        </div>
        <div class="bottom">
          <span class="exam_time" v-if="item.TimeLimit>0">考试时间：{{item.TimeLimit}}分钟</span>
          <span class="exam_time" v-else>考试时间：不限时</span>
