    ...
    <div class="course_detail">
      ...
      <mt-tab-container v-model="selected">
        ...
        <mt-tab-container-item id="evaluate">
          <course-comment :course-id="courseId" :comment-credit="courseDetails.CommentCredit"/>
        </mt-tab-container-item>
      </mt-tab-container>
    </div>
    <!--添加笔记-->
...
<script>
  ...
  import { Toast, Indicator, Navbar, TabItem, TabContainer, TabContainerItem, MessageBox } from 'mint-ui'
  import {
    headerFix, courseIntroduce, courseComment,
