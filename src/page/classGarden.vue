...
<script>
  ...
  import { classList, headerFix } from '../components'
  import { goBack } from '../service/mixins'
  import { GetTrainingClass, GetTrainingTypeList } from '../service/getData'
  ...
  export default {
    ...
    methods: {
      ...
      async getClassCategory () {
        ...
        if (data.Type == 1) {
          this.classCategory = [{ TypeId: 0, TypeName: '全部班级', ParentId: 0 }, ...data.Data.TrainClassList]
          this.typeId = this.classCategory[0].TypeId
        }
      },
      //班级列表
      async getClassList () {
