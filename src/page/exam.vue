<template>
  <div class="exam_page container_both">
    <!--头部-->
  ...
  export default {
    ...
    methods: {
      ...
      nextItem () {
        ...
        } else if (this.itemData.ThemeType === 3) {
      ...
      async upDateExam () {
        ...
        // let params = t.choosedItem;
        UpdateUserExam({ StartTime: t.startDate, ticket: t.ticket, ExamId: t.examId, Data: params })
          .then(function (data) {
            if (data.Type === 1) {
