...
<template>
  <div class="article_container">
    ...
    <div class="article_footer">
      <!--<mt-button v-if="!articleDetails.IsCollection" size="normal" type="primary" @click.native="collectNews" plain>
        <i class="webapp webapp-favorite"></i>收藏
      </mt-button>
      <mt-button v-else size="normal" type="primary" @click.native="cancelCollect" plain>
        <i class="webapp webapp-favoritesfilling"></i>取消收藏
      </mt-button>-->
...
<script>
  ...
  import { ArticleDetail, GetWechatWxAuthModel, AddCollectionList, DeleteCollectionList } from '../service/getData'
...
//        let articlePath = this.$router.resolve({path: '/newsDetails', query: {id: t.articleId}})
      ...
      shareWeiBo () {
        ...
        window.open(_shareUrl, '_blank', 'width=' + +',height=' + +',top=' + +',left=' + +',toolbar=no,menubar=no,scrollbars=no, resizable=1,location=no,status=0')
      },
      toggleShowShare () {
